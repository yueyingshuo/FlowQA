...
from utils import dev_evaluate, write_quac, quac_performance,score
...
def main():
    ...
    if args.do_predict and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        # f1 = quac_performance(pred, nbest_pred, target_dict)
        f1, h_f1, HEQ_Q, HEQ_D = score(pred, target_dict)
        print("Test F1: {:.2f}, HEQ_Q: {:.2f}, HEQ_D: {:.2f}".format(f1, HEQ_Q, HEQ_D))
